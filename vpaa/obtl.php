<?php
    ...
    if($_SESSION['type'] == 'VPAA' && isset($_GET['institute'])){
        $ins_id = $_GET['institute'];
        require '../functions/activity.php';
        require '../functions/report.php';
        $activity = new Activity();
        $obtl = new Reports();
        $obtl_list = $obtl->obtlList($database, $ins_id);
?>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>OBTL REPORTS LIST -- <?php echo $obtl_list[0]['ins_name']; ?></h2>
            </div>
