<!-- Add Schedule Modal -->
<div class="modal fade" id="edit-schedule-modal" tabindex="-1" role="dialog">
            ...
            <div class="modal-body">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div>
                            <div>
                                <form action="../functions/activity.php?activityOpt=true&editSchedule=true&folder=<?php echo $_SESSION['folder']?>" method="POST">

                                    <input type="text" name="reportId" value="" hidden><br>
